...
var live_site_url = "https://yourmovepublishing.com";//"https://your-move-publishing.github.io"; 
...
function enjoyPreorderStripe(){
  var cta_button = document.getElementById("preorder-enjoy-book");
  var cta_replace = document.getElementById("preorder-enjoy-redirecting");
  ...
  stripe.redirectToCheckout({
    lineItems: [{
      price: 'price_1I6caPDmqJwbTDJDJgknsN6k', // book
      quantity: 1,
    }],
    mode: 'payment',
    successUrl: 'https://your-move-publishing.github.io',
